...
public class Main 
{
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		for(int i = 0; i < neurons.size(); i ++)
		{
			...
			System.out.println("Hidden layer outputs " + neurons.get(i).getOutput());
		}
		...
		System.out.println("Output layer output " + (out.getOutput())); 
		...
		do {
			...
			System.out.println("hidden weights" + weightsInHidden);
